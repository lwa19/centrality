...
```{r setup, message = F, warning=FALSE, eval=FALSE}
library(centrality)
...
We will time the speed of overall speed of computing the degree centrality scores of *igraph* and *centrality*. Since the aim of the package is to avoid the tedious graph conversion, we will be including *igraph*'s graph conversion into its total run time. We will also demonstrate their run time differences on large adjacency matrices ($n = 10000$) to see a larger difference. 
