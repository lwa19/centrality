...
test_that("degree centrality (outdegree)", {
  expect_equal(centrality::degree(mat.A, type = "outdegree"),
               igraph::centr_degree(graph.A, mode = "out", normalized = T)$res)
  expect_equal(centrality::degree(mat.B, type = "outdegree"),
               igraph::centr_degree(graph.B, mode = "out", normalized = T)$res)
  expect_equal(centrality::degree(mat.C, type = "outdegree"),
               igraph::centr_degree(graph.C, mode = "out", normalized = T)$res)
})
